...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "publications",
          description: "Thesis and research outputs.",
          section: "Navigation",
          handler: () => {
          ...
          title: "projects",
          description: "Research, engineering, and AI system projects.",
          section: "Navigation",
          handler: () => {
          ...
          title: "CV",
          description: "Education, research focus, experience, and selected project work.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/dingkai_cv.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%32%35%33%31%30%34%36%32%37%38@%71%71.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/dingkai0321", "_blank");
        },
      },{
        id: 'social-work',
        title: 'Work',
        section: 'Socials',
        handler: () => {
          window.open("https://dingkai0321.github.io", "_blank");
        },
      },{
      id: 'light-theme',
